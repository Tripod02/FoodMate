...
import com.example.foodit.models.TermsConditionsViewModel;

public class TermsConditions extends Fragment {

    private TermsConditionsViewModel mViewModel;

    public static TermsConditions newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(TermsConditionsViewModel.class);
